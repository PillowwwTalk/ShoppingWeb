...
public class CartServlet extends BaseServlet {
    ...
    protected void addItem(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 调用MerchandiseService.queryMerchandiseById(id):Merchandise得到商品的信息
        Merchandise merchandise = merchandiseService.queryMerchandiseByid(id);
        // 把商品信息，转换成为CartItem商品项
        CartItem cartItem = new CartItem(merchandise.getId(), merchandise.getName(), 1, merchandise.getPrice(), merchandise.getPrice());
